...
define view entity ZR_TRMIS_ASSET_VAL000                          
  as select from ztrmis_asset_val as AssetVal
  association        to parent ZR_TRMIS_ASSET000 as _Asset            on $projection.AssetUuid = _Asset.AssetUuid
{
  key asset_uuid as AssetUuid,
  key asset_value as AssetValue,
