...
define root view entity ZR_TRMIS_LOCATION
  as select from ZTRMIS_LOCATION
{
  ...
  cfo_cell_phone_number as CfoCellPhoneNumber,
  coo_cell_phone_number as CooCellPhoneNumber,
  hse_cell_phone_number as HseCellPhoneNumber,
  lch2_cell_phone_number as Lch2CellPhoneNumber,
  lch_cell_phone_number as LchCellPhoneNumber,
  maintance_man_cell_phone_num as MaintanceManCellPhoneNum,
  md_cell_phone_num as MdCellPhoneNum,
  ...
  cfo_fax_number as CfoFaxNumber,
  coo_fax_number as CooFaxNumber,
  hse_fax_number as HseFaxNumber,
  lch2_fax_number as Lch2FaxNumber,
  lch_fax_number as LchFaxNumber,
  maintance_man_fax_number as MaintanceManFaxNumber,
  managing_director_fax_number as ManagingDirectorFaxNumber,
  former as Former,
  ...
  cfo_phone_number as CfoPhoneNumber,
  coo_phone_number as CooPhoneNumber,
  hse_phone_number as HsePhoneNumber,
  lch2_phone_number as Lch2PhoneNumber,
  lch_phone_number as LchPhoneNumber,
  maintance_man_phone_number as MaintanceManPhoneNumber,
  managing_director_phone_number as ManagingDirectorPhoneNumber,
